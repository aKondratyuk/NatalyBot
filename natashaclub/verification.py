...
def limit_out(session, receiver_profile_id):
    ...
    text = send_free_message_page.find("div", id="ContentDiv").find("td",
                                                                    class_="text").text
...
def profile_country(profile_id):
    ...
    if country in ["Azerbaijan", "India", "Tajikistan", "Taiwan", "Ecuador",
                   "South Africa", "Colombia",
                   "Saudi Arabia", "China", "Venezuela", "Egypt", "Kuwait",
                   "Jordan", "Russia", "Ukraine", "Qatar",
                   "Turkey", "Brazil", "Peru", "Costa Rica", "Macedonia",
                   "Serbia", "Romania", "Honduras", "Nicaragua",
                   "Morocco", "Bolivia", "Ecuador", "Panama", "Qatar",
                   "Bahrain"]:
        return True
